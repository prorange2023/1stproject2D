...
public class Priest : BattleAI, IDamagable
{
    ...
    private List<BattleAI> teamList;
    ...
    public void ListChoice()
    {
        ...
        if (gameObject.layer == 8)
        {
            this.teamList = Manager.Battle.redAI;
            layerMask = 512;
            
        }
        else if (gameObject.layer == 9)
        {
            this.teamList = Manager.Battle.blueAI;
            layerMask = 256;
    ...
    private class PriestState : BaseState
    {
        protected Priest owner;
        ...
        public PriestState(Priest owner)
        {
            this.owner = owner;
        }
    ...
    private class IdleState : PriestState
    {

        public IdleState(Priest owner) : base(owner) { }
    ...
    private class TraceState : PriestState
    {
        public TraceState(Priest owner) : base(owner) { }
    ...
    private class AvoidState : PriestState
    {


        public AvoidState(Priest owner) : base(owner) { }
    ...
    private class BattleState : PriestState
    {
        public BattleState(Priest owner) : base(owner) { }
    ...
    private class DieState : PriestState
    {
        public DieState(Priest owner) : base(owner) { }
    ...
    private class GameoverState : PriestState
    {
        public GameoverState(Priest owner) : base(owner) { }
